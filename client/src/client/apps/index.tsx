...
export function registerBuiltinApps(): void {
  ...
  registerApp({ id: 'group', label: 'RCS', icon: { img: RCS_ICON }, bg: 'linear-gradient(160deg,#0a84ff,#1c3faa)', component: GroupApp, onOpen: (p) => p.actions.loadGroupList() })
  ...
  registerApp({ id: 'recharge', label: '充值', icon: { d: SF.creditcard }, bg: 'linear-gradient(160deg,#30d158,#1e9e4a)', component: RechargeApp, system: true })
